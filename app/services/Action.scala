...
case class RootAction(contributor: Member, initTags: Array[ActionTag], body: String) extends Action {
  val tags = ActionTag.rootTag +: initTags
}

// DocumentAction is main content of Activity.
case class DocumentAction(contributor: Member, initTags: Array[ActionTag], body: String) extends Action {
  val tags = initTags
}

// CommentAction is contributed by expect for Activity contributor.
// It is a Action to mention to other Action.
case class CommentAction(contributor: Member, initTags: Array[ActionTag], body: String) extends Action {
...
case class QuestionAction(contributor: Member, initTags: Array[ActionTag], body: String) extends Action {
